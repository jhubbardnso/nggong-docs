# ngGONG HLS Documentation

Docs-as-code repository for ngGONG High Level Software documentation.
...
Local builds use Docker, so a native Quarto or LaTeX installation is not
required. Install Docker and Make using the package manager for your platform.

The Makefile builds a small local image from the same Quarto base image used by
